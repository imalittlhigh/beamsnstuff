...
execute positioned ~ ~-0.2 ~ if entity @e[tag=beamsns.interaction.angled_beam,distance=..0.1] positioned ~ ~0.2 ~ run loot spawn ~ ~ ~ loot beamsns:beams/angled/log/oak

#Get rotation of head and place corresponding block displays
execute if block ~ ~ ~ player_head[rotation=4] run summon block_display ~-0.5 ~-0.5 ~-0.5 {Tags:["beamsns.blockdisplay","beamsns.blockdisplay.angled_beam","beamsns.blockdisplay.angled_beam.log","beamsns.blockdisplay.angled_beam.log.oak"],Passengers:[{id:"minecraft:block_display",Tags:["beamsns.blockdisplay","beamsns.blockdisplay.angled_beam","beamsns.blockdisplay.angled_beam.log","beamsns.blockdisplay.angled_beam.log.oak"],block_state:{Name:"minecraft:oak_log",Properties:{}},transformation:[0.1768f,1.0165f,0.0000f,-0.1875f,-0.1768f,1.0165f,0.0000f,0.1875f,0.0000f,0.0000f,0.2500f,0.3750f,0.0000f,0.0000f,0.0000f,1.0000f]}]}
...
execute if block ~ ~ ~ #beamsns:heads positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[tag=beamsns.blockdisplay.angled_beam.log,distance=..0.1] positioned ~0.5 ~0.3 ~0.5 run summon interaction ~ ~ ~ {NoGravity:1b,width:0.7f,height:0.7f,response:1b,Tags:["beamsns.interaction","beamsns.interaction.angled_beam","beamsns.interaction.angled_beam.log","beamsns.interaction.angled_beam.log.oak"]}

#remove the heads if the rotation isnt supported and spawn the head as loot again
execute if block ~ ~ ~ player_head[rotation=1] run loot spawn ~ ~ ~ loot beamsns:beams/angled/log/oak
execute if block ~ ~ ~ player_head[rotation=3] run loot spawn ~ ~ ~ loot beamsns:beams/angled/log/oak
execute if block ~ ~ ~ player_head[rotation=5] run loot spawn ~ ~ ~ loot beamsns:beams/angled/log/oak
execute if block ~ ~ ~ player_head[rotation=7] run loot spawn ~ ~ ~ loot beamsns:beams/angled/log/oak
execute if block ~ ~ ~ player_head[rotation=9] run loot spawn ~ ~ ~ loot beamsns:beams/angled/log/oak
execute if block ~ ~ ~ player_head[rotation=11] run loot spawn ~ ~ ~ loot beamsns:beams/angled/log/oak
execute if block ~ ~ ~ player_head[rotation=13] run loot spawn ~ ~ ~ loot beamsns:beams/angled/log/oak
execute if block ~ ~ ~ player_head[rotation=15] run loot spawn ~ ~ ~ loot beamsns:beams/angled/log/oak
