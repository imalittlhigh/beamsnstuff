...
execute positioned ~ ~-0.2 ~ if entity @e[tag=beamsns.interaction.low_beam,distance=..0.1] positioned ~ ~0.2 ~ run loot spawn ~ ~ ~ loot beamsns:beams/low/log/birch

#Get rotation of head and place corresponding block displays
execute if block ~ ~ ~ player_head[rotation=4] run summon block_display ~-0.5 ~-0.5 ~-0.5 {Tags:["beamsns.blockdisplay","beamsns.blockdisplay.low_beam","beamsns.blockdisplay.low_beam.log","beamsns.blockdisplay.low_beam.log.birch"],Passengers:[{id:"minecraft:block_display",Tags:["beamsns.blockdisplay","beamsns.blockdisplay.low_beam","beamsns.blockdisplay.low_beam.log","beamsns.blockdisplay.low_beam.log.birch"],block_state:{Name:"minecraft:birch_log",Properties:{}},transformation:[-0.0000f,1.0000f,-0.0000f,0.0000f,0.0000f,-0.0000f,-0.2500f,0.2500f,-0.2500f,0.0000f,-0.0000f,0.6250f,0.0000f,0.0000f,0.0000f,1.0000f]}]}
...
execute if block ~ ~ ~ player_head[rotation=0] run summon block_display ~-0.5 ~-0.5 ~-0.5 {Tags:["beamsns.blockdisplay","beamsns.blockdisplay.low_beam","beamsns.blockdisplay.low_beam.log","beamsns.blockdisplay.low_beam.log.birch"],Passengers:[{id:"minecraft:block_display",Tags:["beamsns.blockdisplay","beamsns.blockdisplay.low_beam","beamsns.blockdisplay.low_beam.log","beamsns.blockdisplay.low_beam.log.birch"],block_state:{Name:"minecraft:birch_log",Properties:{}},transformation:[0.2500f,0.0000f,0.0000f,0.3750f,0.0000f,-0.0000f,-0.2500f,0.2500f,0.0000f,1.0000f,-0.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f]}]}
...
execute if block ~ ~ ~ player_head[rotation=2] run summon block_display ~-0.5 ~-0.5 ~-0.5 {Tags:["beamsns.blockdisplay","beamsns.blockdisplay.low_beam","beamsns.blockdisplay.low_beam.log","beamsns.blockdisplay.low_beam.log.birch"],Passengers:[{id:"minecraft:block_display",Tags:["beamsns.blockdisplay","beamsns.blockdisplay.low_beam","beamsns.blockdisplay.low_beam.log","beamsns.blockdisplay.low_beam.log.birch"],block_state:{Name:"minecraft:birch_log",Properties:{}},transformation:[-0.1768f,1.0607f,-0.0000f,0.0625f,0.0000f,-0.0000f,-0.2500f,0.2500f,-0.1768f,-1.0607f,-0.0000f,1.1250f,0.0000f,0.0000f,0.0000f,1.0000f]}]}
...
execute if block ~ ~ ~ player_head[rotation=1] run loot spawn ~ ~ ~ loot beamsns:beams/low/log/birch
execute if block ~ ~ ~ player_head[rotation=3] run loot spawn ~ ~ ~ loot beamsns:beams/low/log/birch
execute if block ~ ~ ~ player_head[rotation=5] run loot spawn ~ ~ ~ loot beamsns:beams/low/log/birch
execute if block ~ ~ ~ player_head[rotation=7] run loot spawn ~ ~ ~ loot beamsns:beams/low/log/birch
execute if block ~ ~ ~ player_head[rotation=9] run loot spawn ~ ~ ~ loot beamsns:beams/low/log/birch
execute if block ~ ~ ~ player_head[rotation=11] run loot spawn ~ ~ ~ loot beamsns:beams/low/log/birch
execute if block ~ ~ ~ player_head[rotation=13] run loot spawn ~ ~ ~ loot beamsns:beams/low/log/birch
execute if block ~ ~ ~ player_head[rotation=15] run loot spawn ~ ~ ~ loot beamsns:beams/low/log/birch
