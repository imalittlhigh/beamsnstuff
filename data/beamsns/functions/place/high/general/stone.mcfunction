...
execute if block ~ ~ ~ player_head[rotation=4] run summon block_display ~-0.5 ~-0.5 ~-0.5 {Tags:["beamsns.blockdisplay","beamsns.blockdisplay.high_beam","beamsns.blockdisplay.high_beam.general","beamsns.blockdisplay.high_beam.general.stone"],Passengers:[{id:"minecraft:block_display",Tags:["beamsns.blockdisplay","beamsns.blockdisplay.high_beam","beamsns.blockdisplay.high_beam.general","beamsns.blockdisplay.high_beam.general.stone"],block_state:{Name:"minecraft:stone",Properties:{}},transformation:[-0.0000f,-1.0000f,0.0000f,1.0000f,-0.0000f,-0.0000f,-0.2500f,1.0000f,0.2500f,0.0000f,-0.0000f,0.3750f,0.0000f,0.0000f,0.0000f,1.0000f]}]}
