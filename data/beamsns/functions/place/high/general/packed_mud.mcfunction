...
execute positioned ~ ~-0.2 ~ if entity @e[tag=beamsns.interaction.angled_beam,distance=..0.1] positioned ~ ~0.2 ~ run loot spawn ~ ~ ~ loot beamsns:beams/angled/general/packed_mud

#Get rotation of head and place corresponding block displays
execute if block ~ ~ ~ player_head[rotation=4] run summon block_display ~-0.5 ~-0.5 ~-0.5 {Tags:["beamsns.blockdisplay","beamsns.blockdisplay.high_beam","beamsns.blockdisplay.high_beam.general","beamsns.blockdisplay.high_beam.general.packed_mud"],Passengers:[{id:"minecraft:block_display",Tags:["beamsns.blockdisplay","beamsns.blockdisplay.high_beam","beamsns.blockdisplay.high_beam.general","beamsns.blockdisplay.high_beam.general.packed_mud"],block_state:{Name:"minecraft:packed_mud",Properties:{}},transformation:[-0.0000f,-1.0000f,0.0000f,1.0000f,-0.0000f,-0.0000f,-0.2500f,1.0000f,0.2500f,0.0000f,-0.0000f,0.3750f,0.0000f,0.0000f,0.0000f,1.0000f]}]}
...
execute if block ~ ~ ~ #beamsns:heads positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[tag=beamsns.blockdisplay.angled_beam.general,distance=..0.1] positioned ~0.5 ~0.3 ~0.5 run summon interaction ~ ~ ~ {NoGravity:1b,width:0.7f,height:0.7f,response:1b,Tags:["beamsns.interaction","beamsns.interaction.angled_beam","beamsns.interaction.angled_beam.general","beamsns.interaction.angled_beam.general.packed_mud"]}

#remove the heads if the rotation isnt supported and spawn the head as loot again
execute if block ~ ~ ~ player_head[rotation=1] run loot spawn ~ ~ ~ loot beamsns:beams/angled/general/packed_mud
execute if block ~ ~ ~ player_head[rotation=3] run loot spawn ~ ~ ~ loot beamsns:beams/angled/general/packed_mud
execute if block ~ ~ ~ player_head[rotation=5] run loot spawn ~ ~ ~ loot beamsns:beams/angled/general/packed_mud
execute if block ~ ~ ~ player_head[rotation=7] run loot spawn ~ ~ ~ loot beamsns:beams/angled/general/packed_mud
execute if block ~ ~ ~ player_head[rotation=9] run loot spawn ~ ~ ~ loot beamsns:beams/angled/general/packed_mud
execute if block ~ ~ ~ player_head[rotation=11] run loot spawn ~ ~ ~ loot beamsns:beams/angled/general/packed_mud
execute if block ~ ~ ~ player_head[rotation=13] run loot spawn ~ ~ ~ loot beamsns:beams/angled/general/packed_mud
execute if block ~ ~ ~ player_head[rotation=15] run loot spawn ~ ~ ~ loot beamsns:beams/angled/general/packed_mud
